            ...
            <div class="label-container">
                <header class="label-header">
                    <div class="logo">
                        ...
                        <div>
                            <pre>Kota Asal      &nbsp;&nbsp;:   <span><?= $invoiceData['origin']['city'] ?? 'N/A' ?></span></pre>
                            <small>(Home Town)</small>
                            <pre>Kota Tujuan    :   <span><?= $invoiceData['destination']['city_name'] ?? 'N/A' ?></span></pre>
                ...
                <section class="shipment-info">
                    <div class="sender-receiver">
                        <div class="sender">
                            ...
                            <div>
                                <pre>Telp/HP       :   <?= $invoiceData['origin']['no_handphone'] ?></pre>
                                <small>(No HP)</small>
                            </div>
                            <div>
                        ...
                        <div class="receiver">
                            ...
                            <div>
                                <pre>Telp/HP       :   <?= $invoiceData['destination']['no_handphone'] ?></pre>
                                <small>(No HP)</small>
                            </div>
                            <div>
