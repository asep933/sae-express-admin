...
class TemplateHTML
{
    public static function generateShippingLabelHTML($data, $shipment, $awbNumber)
    {
        $invoiceData = [
            'origin' => [
                'type' => 'Sender',
                ...
                <section class="shipment-info">
                    <div class="sender-receiver">
                        <div class="sender">
                            ...
                            <div>
                                <pre>No Handphone      :   <?= $invoiceData['origin']['no_handphone'] ?></pre>
                        ...
                        <div class="receiver">
                            ...
                            <div>
                                <pre>No Handphone      :   <?= $invoiceData['destination']['no_handphone'] ?></pre>
                                <small>(No Handphone)</small>
                            </div>
                            <div>
